...
const HomeScreen = () => {
  ...
  const loadData = async () => {
    try {
      ...
      const selectedCategory = apiCategories.filter((cat) => cat.strCategory !== "Beef" && cat.strCategory !== "Pork");
      const transformedCategories =selectedCategory.map((cat, index) => ({
        id: index + 1,
    ...
    <View style={homeStyles.container}>
      ...
      >
        ...
        <View style={homeStyles.welcomeSection}>
          <Image
            source={require("../../assets/images/caulix.png")}
            style={{
              width: 100,
              height: 100,
            }}
          ...
          />
          <Image
            source={require("../../assets/images/milkx.png")}
            style={{
              width: 100,
              height: 100,
            }}
